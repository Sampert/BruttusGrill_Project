...
public class JanelaCadastrarProduto extends javax.swing.JFrame {
    ...
    private DefaultTableModel tableProdutos;
    ...
    public JanelaCadastrarProduto(ProdutoDaoImpl pdi, DefaultTableModel dtm) {
        initComponents();
        this.produtoDaoImpl = pdi;
        this.tableProdutos = dtm;
    }
    ...
    private void initComponents() {
        ...
        labelAvisoPeso = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        labelTitle.setFont(new java.awt.Font("OCR A Extended", 0, 36)); // NOI18N
        ...
        labelAvisoPeso.setFont(new java.awt.Font("OCR A Extended", 0, 14)); // NOI18N
        labelAvisoPeso.setForeground(new java.awt.Color(255, 0, 0));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(labelAvisoPeso, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))))
                .addContainerGap())
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(labelLogin)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(labelAvisoPeso, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(1, 1, 1)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void btGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGravarActionPerformed
        ...
        String nome = this.textNomeProd.getText();
        try {
            Double valor = Double.parseDouble(this.textPreco.getText());
            salvarBancoDados(nome, valor);
        } catch (NumberFormatException ex) {
            this.labelAvisoPeso.setText("Valor incorreto!");
        }
    ...
    private void salvarBancoDados(String nome, Double valor) {
        
        Produto produto = new Produto(nome, valor);
        this.produtoDaoImpl.save(produto);
        
        this.tableProdutos.addRow(new Object[]{produto.getId(), nome, valor});
    ...
    private javax.swing.JLabel labelAvisoPeso;
